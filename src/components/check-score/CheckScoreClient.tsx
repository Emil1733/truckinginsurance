      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        ...
        {loading && (
           <div className="text-center animate-pulse">
             ...
             <p className="text-industrial-400">Fetching live inspection data live</p>
           </div>
        )}
        ...
        {!loading && !data && (
          <div className="w-full max-w-md">
             <h1 className="text-center text-2xl font-bold mb-8 text-industrial-200">CHECK YOUR FMCSA SAFETY SCORE</h1>
