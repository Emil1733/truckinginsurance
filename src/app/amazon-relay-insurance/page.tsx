import { CheckCircle2, AlertTriangle, ShieldCheck, ArrowRight, FileText, Info, Search, ShieldAlert, BadgeCheck, ListChecks, Zap, XCircle, Box, Truck } from "lucide-react";
import Link from "next/link";
import { BROKERS_DATA, ContentSection, AMAZON_SECTIONS } from "@/lib/data/brokers";
...
export default function AmazonRelayInsurancePage() {
  const broker = {
    name: 'Amazon Relay',
    ctaText: 'GET AMAZON-READY QUOTE',
    sections: AMAZON_SECTIONS,
    coiRequirements: [
      'Amazon.com, Inc. and its affiliates - PO Box 81226, Seattle, WA 98108'
    ]
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumbs 
            items={[
              ...
              { label: 'Amazon Relay', href: '/amazon-relay-insurance' }
            ]} 
          />
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20 mb-8">
                ...
                Amazon Relay Fast-Track Approval
              </div>
              <h1 className="text-6xl md:text-8xl font-black tracking-tight text-white leading-[0.9] mb-8">
                Amazon Relay <br/>
                <span className="text-blue-500">Insurance Requirements</span>
              </h1>
              <p className="text-xl text-slate-400 leading-relaxed max-w-2xl">
                The "New Venture Factory." We specialize in getting box truck carriers approved by Amazon in record time by eliminating the #1 reason for rejection: Incorrect Insurance Filings.
              </p>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-slate-900/50 backdrop-blur-xl p-8 rounded-[40px] border border-slate-800 shadow-2xl">
                <h3 className="text-xl font-bold text-white mb-6 flex items-center">
                  ...
                  Get Amazon-Ready Now
                </h3>
                <BrokerLeadForm brokerName="Amazon Relay" ctaText="GENERATE AMAZON QUOTE" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
             ...
             <div className="bg-slate-900/40 border border-slate-800 rounded-[40px] p-10 backdrop-blur-sm mb-12">
              <h2 className="text-3xl font-bold text-white mb-10 flex items-center">
                <Box className="w-8 h-8 mr-4 text-blue-500" />
                Official Relay Requirements
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { label: 'Auto Liability', val: '$1,000,000' },
                  { label: 'Cargo Insurance', val: '$100,000' },
                  { label: 'General Liability', val: '$1M / $2M Agg' },
                  { label: 'Trailer Interchange', val: '$50,000' },
                ].map((item, i) => (
                  <div key={i} className="p-8 bg-slate-950/50 rounded-3xl border border-slate-800 group hover:border-blue-500/50 transition-all">
            ...
            {broker.sections.map((section, index) => (
              <div key={index}>
                ...
                {section.type === 'callout' && (
                   <div className="bg-blue-600/10 border border-blue-500/20 rounded-[32px] p-8 mb-12 flex gap-6">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-[40px] p-10">
                <h3 className="text-xl font-bold text-white mb-6">Required Holder Address</h3>
                <div className="p-6 bg-slate-950 rounded-2xl border border-slate-800 font-mono text-xs text-blue-400 leading-relaxed">
                  Amazon.com, Inc. and its affiliates<br/>
                  PO Box 81226<br/>
                  Seattle, WA 98108
                </div>
                <p className="mt-6 text-sm text-slate-500 leading-relaxed">
                  Amazon uses OCR (Optical Character Recognition) to verify certificates. One typo in this address will lead to an automatic 14-day suspension.
                </p>
              </div>

              <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-10 rounded-[40px] text-white shadow-2xl relative overflow-hidden">
                <h3 className="text-2xl font-bold mb-4 relative z-10">Peak Season Ready?</h3>
                <p className="text-blue-100 text-sm mb-8 relative z-10">
                  We offer 24/7 automated COI updates so you can add trucks to your Amazon portal instantly.
                </p>
                <Link href="/contact" className="bg-white text-blue-700 font-bold px-8 py-4 rounded-2xl inline-block relative z-10 hover:bg-slate-100 transition-all">
                  Audit My MC#
                </Link>
              </div>
            </div>
