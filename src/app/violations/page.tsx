...
export const metadata = {
  ...
  description:
    "Search the complete list of FMCSA violation codes. See which codes trigger automatic insurance denials and how to fix them.",
  alternates: {
    ...
    <div className="min-h-screen bg-industrial-900 font-mono text-silver">
      <nav className="border-b border-industrial-800 bg-industrial-900/90 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link
            href="/quote"
            className="text-xs font-bold bg-safety-orange text-black px-4 py-2 rounded"
          >
            GET INSURED
          </Link>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-industrial-400 max-w-2xl">
            A complete index of safety violations that impact your insurance
            premiums. We insure carriers with active violations in all tiers.
          </p>
        </header>
                ...
                <span
                  className={`text-xs px-2 py-1 rounded font-bold border ${
                    v.severity_tier >= 9
                      ...
                      : v.severity_tier >= 7
                        ? "bg-orange-900/30 text-orange-500 border-orange-900"
