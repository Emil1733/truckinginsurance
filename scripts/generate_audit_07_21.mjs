...
async function runAudit() {
  ...
  const last30Start = '2026-06-20';
  const last30End = '2026-07-19';
  
  // Previous 30 Days
  const prev30Start = '2026-05-21';
  const prev30End = '2026-06-19';

  const exportDir = 'c:/Users/tevat/truckinsurancesite/gsc_exports/07-21-2026';
  ...
  try {
    ...
    last30Data.sort((a,b) => b.impressions - a.impressions).slice(0, 10).forEach(r => {
