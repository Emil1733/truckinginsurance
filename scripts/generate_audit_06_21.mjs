...
async function runAudit() {
  ...
  const last30Start = '2026-05-21';
  const last30End = '2026-06-19';
  
  // Previous 30 Days
  const prev30Start = '2026-04-21';
  const prev30End = '2026-05-20';

  const exportDir = 'c:/Users/tevat/truckinsurancesite/gsc_exports/06-21-2026';
