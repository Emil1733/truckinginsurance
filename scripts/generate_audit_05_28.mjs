...
async function generateAudit() {
  console.log('--- GSC Forensic Audit (05/08 - 05/28) ---');
  
  const startDate = '2026-05-08';
  const endDate = '2026-05-26'; // Accounting for 2-day GSC lag
  
  const exportDir = 'c:/Users/tevat/truckinsurancesite/gsc_exports/05-28-2026';
